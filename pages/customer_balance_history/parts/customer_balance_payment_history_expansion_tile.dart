...
class CustomerBalancePaymentHistoryExpansionTile extends ConsumerWidget {
  const CustomerBalancePaymentHistoryExpansionTile({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    AsyncValue<List<CustomerBalanceHistory>> cbhs =
        ref.watch(getVisitPaymentsByCardCodeProvider(cardCode));
